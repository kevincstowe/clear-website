/* 
	...
	modified Jena Hwang to allow for expanded menu for selected webpage
*/
...
//			keepOpen(items[i]);
	...
	this.listItem = function(li){
		// if the li has under it a ul:
		if(li.getElementsByTagName("ul").length > 0){
			// grab the ul
			var ul = li.getElementsByTagName("ul")[0];
			if (li.className != document.title) {
